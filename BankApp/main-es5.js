...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.setBankDetails = function (res) {
    ...
    AppComponent.prototype.eventSelection = function (event) {
        this.getBankDetails(this.selectedCity);
    };
    AppComponent.prototype.getBankDetails = function (cityToGetDetails) {
        var _this = this;
        this.bankService.getBankDetails(cityToGetDetails).subscribe(function (res) {
            debugger;
            //Add a new property favourite to show the favouite rows
            Object.values(res).forEach(function (e) { return (e.favourite = false); });
            _this.dataWithFavourite(res);
        });
    };
    // Get the data with favourite selection changes
    AppComponent.prototype.dataWithFavourite = function (dataObject) {
        switch (this.selectedCity) {
            case "BANGALORE":
                this.favouriteList.BANGALORE.forEach(function (obj) {
                    var index = Object.values(dataObject).findIndex(function (e) { return e["ifsc"] === obj; });
                    dataObject[index].favourite = true;
                });
                this.setBankDetails(dataObject);
                break;
            case "KOLKATA":
                this.favouriteList.KOLKATA.forEach(function (obj) {
                    var index = Object.values(dataObject).findIndex(function (e) { return e["ifsc"] === obj; });
                    dataObject[index].favourite = true;
                });
                this.setBankDetails(dataObject);
                break;
            case "MUMBAI":
                this.favouriteList.MUMBAI.forEach(function (obj) {
                    var index = Object.values(dataObject).findIndex(function (e) { return e["ifsc"] === obj; });
                    dataObject[index].favourite = true;
                });
                this.setBankDetails(dataObject);
                break;
            case "DELHI":
                this.favouriteList.DELHI.forEach(function (obj) {
                    var index = Object.values(dataObject).findIndex(function (e) { return e["ifsc"] === obj; });
                    dataObject[index].favourite = true;
                });
                this.setBankDetails(dataObject);
                break;
            case "CUTTACK":
                this.favouriteList.CUTTACK.forEach(function (obj) {
                    var index = Object.values(dataObject).findIndex(function (e) { return e["ifsc"] === obj; });
                    dataObject[index].favourite = true;
                });
                this.setBankDetails(dataObject);
    ...
    AppComponent.prototype.selectedRowData = function (rowData) {
        debugger;
        switch (this.selectedCity) {
            case "BANGALORE":
...
var BankingService = /** @class */ (function () {
    ...
    BankingService.prototype.getBankDetails = function (city) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        params = params.append('city', city);
        var getBankDetails = 'https://vast-shore-74260.herokuapp.com/banks';
